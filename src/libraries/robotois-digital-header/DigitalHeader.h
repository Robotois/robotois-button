...
#define DIGITAL_HEADER1_1 RPI_V2_GPIO_P1_11 // 3.3v Logic IO
...
#define DIGITAL_HEADER3_2 RPI_V2_GPIO_P1_22 // 3.3v Logic IO
#define DIGITAL_HEADER4 0x04
#define DIGITAL_HEADER4_1 RPI_V2_GPIO_P1_29 // 3.3v Logic IO
#define DIGITAL_HEADER4_2 RPI_V2_GPIO_P1_31 // 3.3v Logic IO
#define DIGITAL_HEADER5 0x05
#define DIGITAL_HEADER5_1 RPI_V2_GPIO_P1_33 // 3.3v Logic IO
#define DIGITAL_HEADER5_2 RPI_V2_GPIO_P1_35 // 3.3v Logic IO
#define DIGITAL_HEADER6 0x06
#define DIGITAL_HEADER6_1 RPI_V2_GPIO_P1_36 // 3.3v Logic IO
#define DIGITAL_HEADER6_2 RPI_V2_GPIO_P1_37 // 3.3v Logic IO
